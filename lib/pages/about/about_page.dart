...
import '../../companents/first_lvl_txt.dart';

class AboutSafetyPage extends StatelessWidget {
...
If at any time you would like to unsubscribe from receiving future emails, you can email us at book@arcticseatours.is
...
''';
  ...
  const AboutSafetyPage({super.key});
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              TextLVL1(txt: "Privacy Policy"),
              SizedBox(
                height: 24,
              ),
              TextLVLAnySize(txt: _msg ,size: 14 , )
            ],
          ),
        ),
      ),
